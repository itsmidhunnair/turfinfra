      ...
      <div className="w-full">
        ...
        <div className="mt-5">
          <p>
            ...
            that stands at the forefront of the industry, embodying a commitment
            to excellence, innovation, and unwavering professionalism. With a
            diverse portfolio spanning various sectors.
          </p>
          <p className="mt-3">
            ...
            Construction, Building Construction, Infrastructure Work, Commercial
            Projects, Residential Projects, Trimix Work for Roads, IPS Flooring
